// Buckley.go, formerly rudd_Large_070925.go
// version 28 AUG 2025 @ 1800 hrs
...
func main() {
	...
	// ps2ns ===========================================================
	// =================================================================
	ps2ns := func(ps16_i, ps8_i, ps4_i, ps2_i, ps1_i, in4_i, in2_i, in1_i nd, fault_A string) (nd, nd, nd, nd, nd, nd, nd, nd) {

		fmt.Println("ps16", allSAT(ps16_i, str2nd))
		fmt.Println("ps8 ", allSAT(ps8_i, str2nd))
		fmt.Println("ps4 ", allSAT(ps4_i, str2nd))
		fmt.Println("ps2 ", allSAT(ps2_i, str2nd))
		fmt.Println("ps1 ", allSAT(ps1_i, str2nd))
		fmt.Println("in4 ", allSAT(in4_i, str2nd))
		fmt.Println("in2 ", allSAT(in2_i, str2nd))
		fmt.Println("in1 ", allSAT(in1_i, str2nd))

		// This function implements the fault-propagation logic
		// for a large sequential circuit, based on the
		// ps2ns.vhdl description of a 5-bit up/down counter.
		...
		in4_s, in4_1 := piRule(null, in4_i)
		in4_s = applyFault(in4_s, in4_1, fault_A, "in4")

		in2_s, in2_1 := piRule(null, in2_i)
		in2_s = applyFault(in2_s, in2_1, fault_A, "in2")

		in1_s, in1_1 := piRule(null, in1_i)
		...
		fmt.Printf("ns16_s: %v\n", allSAT(ns16_s, str2nd))
		fmt.Printf("ns8_s: %v\n", allSAT(ns8_s, str2nd))
		fmt.Printf("ns4_s: %v\n", allSAT(ns4_s, str2nd))
		fmt.Printf("ns2_s: %v\n", allSAT(ns2_s, str2nd))
		fmt.Printf("ns1_s: %v\n", allSAT(ns1_s, str2nd))
		fmt.Printf("out4_s: %v\n", allSAT(out4_s, str2nd))
		fmt.Printf("out2_s: %v\n", allSAT(out2_s, str2nd))
		fmt.Printf("out1_s: %v\n", allSAT(out1_s, str2nd))
	...
	peek := func(fp int, s nd, fault_A string, fault_C string, allSATFunc func(nd, func(string) nd) []string, nd2strFunc func(nd) string, siMap map[string]SIMapping) {
		...
		// Initialize inputs to null (no constraints)
		in4_i, in2_i, in1_i = null, null, null

		// ps2ns =======================================================
		out4_s, out2_s, out1_s, ns16_s, ns8_s, ns4_s, ns2_s, ns1_s :=
			ps2ns(pt16, pt8, pt4, pt2, pt1, in4_i, in2_i, in1_i, fault_A)
		// =============================================================
