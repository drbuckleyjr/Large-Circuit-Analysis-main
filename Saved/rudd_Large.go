// rudd_Large.go
// refactored by GitHub/Copilot 26 MAY 2025 @ 2200 hrs
...
func main() {
	...
	allSAT := func(f nd) []string {
		...
		return g // list of S/I's in the nd function
	...
	ns2fp := func(out4_s, out2_s, out1_s,
		ns16_s, ns8_s, ns4_s, ns2_s, ns1_s nd) (S, S, S, S, S, S, S,
		...
		return dMfp1, dMfp2, dMfp3, dMfp4, dMfp5, dMfp6, dMfp7,
	...
	setUP := func(usi string, first, ns16b, ns8b, ns4b, ns2b, ns1b bool) (bool, bool, bool, bool, bool, bool, bool, bool) {
		// Lookup table for ps1i, ps0i, in1i, in0i values
		lookup := map[string][8]bool{
			"s0i0": {false, false, false, false, false, false, false, false},
			"s0i1": {false, false, false, true, false, false, false, false},
			"s0i2": {false, false, true, false, false, false, false, false},
			"s0i3": {false, false, true, true, false, false, false, false},
			"s0i4": {false, false, true, true, true, false, false, false},
			"s0i5": {false, false, true, true, true, true, false, false},
			"s0i6": {false, false, true, true, true, true, true, false},
			"s0i7": {false, false, true, true, true, true, true, true},
			"s1i0": {false, true, false, false, false, false, false, false},
			"s1i1": {false, true, false, true, false, false, false, false},
			"s1i2": {false, true, true, false, false, false, false, false},
			"s1i3": {false, true, true, true, false, false, false, false},
			"s1i4": {false, true, true, true, true, false, false, false},
			"s1i5": {false, true, true, true, true, true, false, false},
			"s1i6": {false, true, true, true, true, true, true, false},
			"s1i7": {false, true, true, true, true, true, true, true},
			"s2i0": {true, false, false, false, false, false, false, false},
			"s2i1": {true, false, false, true, false, false, false, false},
			"s2i2": {true, false, true, false, false, false, false, false},
			"s2i3": {true, false, true, true, false, false, false, false},
			"s2i4": {true, false, true, true, true, false, false, false},
			"s2i5": {true, false, true, true, true, true, false, false},
			"s2i6": {true, false, true, true, true, true, false, false},
			"s2i7": {true, false, true, true, true, true, true, false},
			"s3i0": {true, true, false, false, false, false, false, false},
			"s3i1": {true, true, false, true, false, false, false, false},
			"s3i2": {true, true, true, false, false, false, false, false},
			"s3i3": {true, true, true, true, false, false, false, false},
			"s3i4": {true, true, true, true, true, false, false, false},
			"s3i5": {true, true, true, true, true, true, false, false},
			"s3i6": {true, true, true, true, true, true, false, false},
			"s3i7": {true, true, true, true, true, true, true, false},
			"s4i0": {false, false, false, false, true, false, false, false},
			"s4i1": {false, false, false, true, true, false, false, false},
			"s4i2": {false, false, true, false, true, false, false, false},
			"s4i3": {false, false, true, true, true, false, false, false},
			"s4i4": {false, false, true, true, true, true, false, false},
			"s4i5": {false, false, true, true, true, true, true, false},
			"s4i6": {false, false, true, true, true, true, true, true},
			"s4i7": {false, false, true, true, true, true, true, true},
			"s5i0": {false, true, false, false, true, false, false, false},
			"s5i1": {false, true, false, true, true, false, false, false},
			"s5i2": {false, true, true, false, true, false, false, false},
			"s5i3": {false, true, true, true, true, false, false, false},
			"s5i4": {false, true, true, true, true, true, false, false},
			"s5i5": {false, true, true, true, true, true, true, false},
			"s5i6": {false, true, true, true, true, true, true, true},
			"s5i7": {false, true, true, true, true, true, true, true},
			"s6i0": {true, false, false, false, true, false, false, false},
			"s6i1": {true, false, false, true, true, false, false, false},
			"s6i2": {true, false, true, false, true, false, false, false},
			"s6i3": {true, false, true, true, true, false, false, false},
			"s6i4": {true, false, true, true, true, true, false, false},
			"s6i5": {true, false, true, true, true, true, true, false},
			"s6i6": {true, false, true, true, true, true, false, false},
			"s6i7": {true, false, true, true, true, true, true, false},
			"s7i0": {true, true, false, false, true, false, false, false},
			"s7i1": {true, true, false, true, true, false, false, false},
			"s7i2": {true, true, true, false, true, false, false, false},
			"s7i3": {true, true, true, true, true, false, false, false},
			"s7i4": {true, true, true, true, true, true, false, false},
			"s7i5": {true, true, true, true, true, true, true, false},
			"s7i6": {true, true, true, true, true, true, true, false},
			"s7i7": {true, true, true, true, true, true, true, false},
			"s8i0": {false, false, false, false, false, true, false, false},
			"s8i1": {false, false, false, true, false, true, false, false},
			"s8i2": {false, false, true, false, false, true, false, false},
			"s8i3": {false, false, true, true, false, true, false, false},
			"s8i4": {false, false, true, true, true, true, false, false},
			"s8i5": {false, false, true, true, true, true, true, false},
			"s8i6": {false, false, true, true, true, true, true, false},
			"s8i7": {false, false, true, true, true, true, true, true},
			"s9i0": {false, true, false, false, false, true, false, false},
			"s9i1": {false, true, false, true, false, true, false, false},
			"s9i2": {false, true, true, false, false, true, false, false},
			"s9i3": {false, true, true, true, false, true, false, false},
			"s9i4": {false, true, true, true, true, true, false, false},
			"s9i5": {false, true, true, true, true, true, true, false},
			"s9i6": {false, true, true, true, true, true, true, false},
			"s9i7": {false, true, true, true, true, true, true, true},
			"s10i0": {true, false, false, false, false, true, false, false},
			"s10i1": {true, false, false, true, false, true, false, false},
			"s10i2": {true, false, true, false, false, true, false, false},
			"s10i3": {true, false, true, true, false, true, false, false},
			"s10i4": {true, false, true, true, true, true, false, false},
			"s10i5": {true, false, true, true, true, true, true, false},
			"s10i6": {true, false, true, true, true, true, true, false},
			"s10i7": {true, false, true, true, true, true, true, true},
			"s11i0": {true, true, false, false, false, true, false, false},
			"s11i1": {true, true, false, true, false, true, false, false},
			"s11i2": {true, true, true, false, false, true, false, false},
			"s11i3": {true, true, true, true, false, true, false, false},
			"s11i4": {true, true, true, true, true, true, false, false},
			"s11i5": {true, true, true, true, true, true, true, false},
			"s11i6": {true, true, true, true, true, true, true, false},
			"s11i7": {true, true, true, true, true, true, true, false},
			"s12i0": {false, false, false, false, false, false, true, false},
			"s12i1": {false, false, false, true, false, false, true, false},
			"s12i2": {false, false, true, false, false, false, true, false},
			"s12i3": {false, false, true, true, false, false, true, false},
			"s12i4": {false, false, true, true, true, true, false, false},
			"s12i5": {false, false, true, true, true, true, true, false},
			"s12i6": {false, false, true, true, true, true, true, false},
			"s12i7": {false, false, true, true, true, true, true, true},
			"s13i0": {false, true, false, false, false, false, true, false},
			"s13i1": {false, true, false, true, false, false, true, false},
			"s13i2": {false, true, true, false, false, false, true, false},
			"s13i3": {false, true, true, true, false, false, true, false},
			"s13i4": {false, true, true, true, true, true, false, false},
			"s13i5": {false, true, true, true, true, true, true, false},
			"s13i6": {false, true, true, true, true, true, true, false},
			"s13i7": {false, true, true, true, true, true, true, true},
			"s14i0": {true, false, false, false, false, false, true, false},
			"s14i1": {true, false, false, true, false, false, true, false},
			"s14i2": {true, false, true, false, false, false, true, false},
			"s14i3": {true, false, true, true, false, false, true, false},
			"s
		}

		// Default values if `usi` is not found
		values, exists := lookup[usi]
		if !exists {
			values = [4]bool{false, false, false, false}
		}

		ps1i, ps0i, in1i, in0i := values[0], values[1], values[2], values[3]
	...
	one_set_BOOL := func(ps1a, ps0a, in1i, in0i bool, fault_C string) (bool, bool, bool, string) {
	...
	peek := func(fp int, s nd, fault_A, fault_B, fault_C string) {
		...
		out4_s, out2_s, out1_s, ns16_s, ns8_s, ns4_s, ns2_s, ns1_s :=
			ps2ns(pt16, pt8, pt4, pt2, pt1, fault_A, fault_B)
		// =============================================================
		...
		// Helper function to convert `nd` to string
			...
			for _, dM := range dMfpx {
				if !eq(and(lns, dM.si), null) || eq(lns, null) {
					fmt.Printf("%s  %s %s %s  fp = %d  ns = %s\n",
						allSAT(dM.si), allSAT(dM.out_4), allSAT(dM.out_2),
						allSAT(dM.out_1), fpn, nd2str(dM.ns))
				}
			}
		}
	...
	foo := func() {
		// Helper function to convert string to `nd`
		...
		for {
			...
			var fault_A, fault_B, fault_C string
			fmt.Print("Enter a fault_A name:    ")
			fmt.Scanln(&fault_A)
			fmt.Print("Enter a fault_B name:    ")
			fmt.Scanln(&fault_B)
			...
			for {
				...
				// Call `peek` function
				peek(fp, s, fault_A, fault_B, fault_C)
				fmt.Println("========================================================3")
				...
				ps1a, ps0a, in1i, in0i := setUP(usi, first, ns1h, ns0h)
				outb, ns1b, ns0b, state := one_set_BOOL(ps1a, ps0a, in1i, in0i, fault_C)
				...
				// Print results
				fmt.Printf("outb: %v    next_state: %s    fault_C: %s\n", outb, state, fault_C)
				fmt.Println("========================================================4")
			}
		}
	}
