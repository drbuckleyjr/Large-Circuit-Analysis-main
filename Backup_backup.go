...
// [MOVED TO archived_fault_analysis.go]
// simulateAndCategorizeFaults - fault simulation and categorization function moved to archive

// [REMOVED] showDetailedResultsPaginated - was only used by archived complex simulateAndCategorizeFaults

// [REMOVED - xx3 not used in workflow]
...
// =================================================================
// SEARCH functions moved to circuit_search.go
// =================================================================
...
func activatePropagateFaultA(ps16_i, ps8_i, ps4_i, ps2_i, ps1_i nd,
	...
	// Debug function to display all output line values using allSAT
	debugOutputLines := func() {
		fmt.Printf("\n=== OUTPUT LINE ANALYSIS (using allSAT) ===\n")

		// Output lines
		out4Values := allSAT(out4_s, str2nd)
		out2Values := allSAT(out2_s, str2nd)
		out1Values := allSAT(out1_s, str2nd)
		...
		// Next state lines
		ns16Values := allSAT(ns16_s, str2nd)
		ns8Values := allSAT(ns8_s, str2nd)
		ns4Values := allSAT(ns4_s, str2nd)
		ns2Values := allSAT(ns2_s, str2nd)
		ns1Values := allSAT(ns1_s, str2nd)

		fmt.Printf("Next State Lines:\n")
		fmt.Printf("  ns16_s: %v\n", ns16Values)
		fmt.Printf("  ns8_s:  %v\n", ns8Values)
		fmt.Printf("  ns4_s:  %v\n", ns4Values)
		fmt.Printf("  ns2_s:  %v\n", ns2Values)
		fmt.Printf("  ns1_s:  %v\n", ns1Values)
		fmt.Printf("=== END OUTPUT LINE ANALYSIS ===\n\n")
	}

	// Call the debug function to show output line values
	if debugLineAnalysis {
		debugOutputLines()
	}
...
// End of activatePropagateFaultA() ================================================
...
func displayAvailableTransitions(fp int, s nd, fault_A string, _ string, allSAT func(nd, func(string) nd) []string, nd2str func(nd) string, siMap map[string]SIMapping) map[string]SIMapping {
	...
	// [MOVED TO archived_fault_analysis.go]
	// countSameAsFaultA - fault interference counting function moved to archive
